...
- **Version badge**: V1.29 in bottom-right corner on every page
...
## Version History
- **V1.29**: Simplified the left sidebar menu across all 13 pages. Removed the cluttered three-section layout (Menu / Practice Tools / Account) with 13 links. Replaced with a clean flat list of 6 main page links: Home, Practice, Learn, Encrypt / Decrypt, Saved Keys, My Profile. Sub-tool pages (PGP Bot Practice, Fingerprint Validator, Password Strength, Threat Modeling, Social Engineering, Eavesdropper View, Sign & Verify) are accessed through the Practice hub page, not the sidebar. Bumped version badge to V1.29.
